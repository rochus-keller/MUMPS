...
SB1     S X=$E(L,H),R=$E(L,H,H+2),H=H+1 G SB1:X=" " Q:X=";"!(X="")!(X'?1A)  F H=H:1 Q:$E(L,H)'?1A
        ...
        G SB1:"Q"[X S B="WR"[X,G="BCFHIJKLNORSUVWX"[X,K="FKNORS"[X*2,M=X I X="V" S ^UTILITY("SUM1",%JB,%I,0,"VIEW")="",^UTILITY("SUM
1",%JB,0,0,"VIEW")=""
...
P2      Q:C'?1AP.E  S V="",%T=$E(T,1) Q:%T=""!'$F("VAGP",%T)  S %S=$E(T,2) I '$D(^UTILITY("SUM1",%JB,%I,%T,C)) S ^UTILITY("SUM1",%JB
,%I,%T,C)=%S Q
