...
GOT     S DDBSTR=WORD+22,DDBSIZ=$V(WORD+5,USRMM),DEV=$V(WORD+4,USRMM)#256
        F %I=1:1:DEV S DEVNUM=$V(DDBSTR+8,USRMM)#256+51 S DDBSTR=DDBSTR+DDBSIZ I $V(DEVNUM+DEVTAB)#256'=0,$V(DEVNUM+DEVTAB)#256'=255
 G INUSE
        S DDBSTR=WORD+22
        F %I=1:1:DEV S DEVNUM=$V(DDBSTR+8,USRMM)#256+51 S DDBSTR=DDBSTR+DDBSIZ,LINE=DEVNUM#2,TMP=$V(DEVTAB+DEVNUM-LINE) S:LINE TMP=T
MP#256+65280 S:'LINE TMP=TMP\256*256+255 V DEVTAB+DEVNUM-LINE::TMP K ^SYS(0,"LOADED DRIVERS",DEVNUM)
