...
SB1     S SIZ=^UTILITY("SUM1",%JB,NAM,0)
        W !,NAM,?9,SIZ,?18,"   ",HEAD,!!
        F X=1:1:4 S V=-1,Y=$E("VAGP",X) D SB2 W:X=3&$D(^UTILITY("SUM1",%JB,NAM,0,"NAKED")) !!?2,"NAKED REFERENCES" W:X=1&$D(^("$VIEW
")) !!?2,"$VIEW FUNCTION USED" W:X=1&$D(^("VIEW")) !!?2,"VIEW COMMAND USED" W !!
        H:TRM 1 W # Q
