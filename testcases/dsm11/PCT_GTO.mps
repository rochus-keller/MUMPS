...
GLOB    D GTO^%G1 I %="" G GO:^UTILITY($J,"%"),DONE
        ...
        F %1I=0:1:%("C") F %1J=1:1 Q:'$D(%(%1I,%1J))  S ^UTILITY($J,"%",%1X,%1I,%1J)=%(%1I,%1J),^(%1J,"S")=%(%1I,%1J,"S") S:$D(%(%1I,%1J,"C")) ^("C")=%(%1I,%1J,"C")
        G GLOB
        -
GO      ;D DIS:'%INT,INT^%D,INT^%T U %IOD S %1DTM=%DAT1_"     "_%TIM,%1EX="W $S(%G[""["":""^""_$E(%G,$F(%G,""]""),$L(%G)),1:%G),!,%D,!"
GO      D DIS:'%INT,INT^%D,INT^%T U %IOD S %1DTM=%DAT1_"     "_%TIM,%1EX="W $S($E(%G,2)=""["":""^""_$E(%G,$F(%G,""]""),$L(%G)),1:%G),!,%D,!"
        S %1LF=1
        ;I %DTY="MT" S:%MTM["V" %1LF=0,%1EX="W $S(%G[""["":""^""_$E(%G,$F(%G,""]""),$L(%G)),1:%G),%D" S %1EX="S $ZT=""MT^%GTO"" "_%1EX_" G:($ZA\1024#2) MT^%GTO"
        I %DTY="MT" S:%MTM["V" %1LF=0,%1EX="W $S($E(%G,2)=""["":""^""_$E(%G,$F(%G,""]""),$L(%G)),1:%G),%D" S %1EX="S $ZT=""MT^%GTO"" "_%1EX_" G:($ZA\1024#2) MT^%GTO"
        ...
        D KQ^%G G DONE
        -
GLS     U %IOD K % S %=^UTILITY($J,"%",%1GLS),ZA=$ZA,ZB=$ZB U 0 I %IOD'=$I W !,"Output started for ^"_% W:%IOD>58&(%IOD<63) " starting with block ",ZA," byte ",ZB W " at " D ^%T
        F %1I="C","D","M","P" S %(%1I)=^UTILITY($J,"%",%1GLS,%1I)
        F %1I=0:1:%("C") F %1J=1:1 Q:'$D(^UTILITY($J,"%",%1GLS,%1I,%1J))  S %(%1I,%1J)=^(%1J),%(%1I,%1J,"S")=^(%1J,"S") S:$D(^("C")) %(%1I,%1J,"C")=^("C")
