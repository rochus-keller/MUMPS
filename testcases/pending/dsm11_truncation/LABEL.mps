...
VOLNAM  W !,"What 3-character uppercase name do you wish to give this volume set ? " R VOLNAM
        I VOLNAM'?3U W !,"This name will be written into the label of each disk volume of the set.",!,"The volume set name must be 3
 uppercase alphabetics." G VOLNAM
        S CODE=$P($H,",",2)#65536
        Q
SIZ     S %SIZ=%MP Q
...
NWMA    G OK:MLB=""!(MB="M")
        I $V(881,0) W !,*7,"*** An in-use Backup cannot be made a Master ***",!,"*** Please use ^DISKPREP for this purpose. ***",! G
 NBAK
