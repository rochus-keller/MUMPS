...
OPEN    D O63 G:O63 EXIT^BLDMP S UTLB=$V($V(44)+158) V ARG1:ARG2 S BLOFF=$V(1022,0),BTYP=$V(1021,0),P=1018 S:BLOFF BLOFF=BLOFF-1 S:BTYP=1 P=1014
...
ASCII   Q:YI=0  W !,?17 S HOLD=YI,YI=YI-16 F A=YI:1:HOLD-1 S:(A#2) X=-1 S:'(A#2) X=1 S P=$V(A,0)#256 S:(P<32!(P>127)) P=42 W $J($C(P),2) I (A#2) W "    "
        S YI=HOLD W ! Q
