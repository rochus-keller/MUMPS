...
UPD     F J=13:2:27 I $A(C,J+1),$A(C,J) S VS=$A(C,J+1)*256+$A(C,J) D
        ...
        ..I $V(2,$J)\64#2 D STAT W "WARNING - Node ",$C(N\2048+64,N\64#32+64,N\2#32+64)," has mounted Volume Set ",$C(VS\2048+64,VS\
64#32+64,VS\2#32+64)," which is already mounted on this node"
