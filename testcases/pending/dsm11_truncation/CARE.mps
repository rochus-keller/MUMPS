...
4       R !!,"Do you want to print the hardware error log first? <Y/N> ",%I Q:%I=""!(%I="^")  D:%I="Y" ^KTR
        ...
        S HH=+$H,TY=-1
        F IN=1:1 S TY=$N(^SYS(0,"ERROR",TY)) Q:TY=-1  S H=HH-^(TY),UNT=-1 F JN=1:1 S UNT=$N(^SYS(0,"ERROR",TY,UNT)) Q:UNT=-1  S D=-1
,C=0 D PUR
        Q
PUR     F I=1:1 S D=$N(^SYS(0,"ERROR",TY,UNT,D)) Q:D=-1  I D'>H S J=-1 F I=1:1 S J=$N(^SYS(0,"ERROR",TY,UNT,D,J)) Q:J=-1  K ^SYS(0,"
ERROR",TY,UNT,D,J) S C=C+1
...
GRET    I $D(^SYS(0,"ERROR",TY))#2=0 S ^SYS(0,"ERROR",TY)=0
        ...
        I H="?" W !!,"Enter Number of Days in the past that you wish to retain errors in ^SYS for this",!,"device. To retain zero da
ys will purge all errors.",! G GRET
        I H="" Q
        I H="^" S TY=-1 Q
