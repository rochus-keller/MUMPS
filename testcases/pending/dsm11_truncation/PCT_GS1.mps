...
%ST     U 0 K %DX,%CK,FLG S %NAM=$ZS(^UTILITY($J,%NAM)) I %NAM="" S POS=1 U %IOD W:%CTC "**","**" W:'%CTC "**",!,"**",! G %END
        ...
        S F=0 F I=1:1 S F=$F(GLREF,",",F) Q:'F  S ST(I)=$P($P(GLREF,",",I),"-",1),EN(I)=$P($P(GLREF,",",I),"-",2) I EN(I)="" S EN(I)
=ST(I)
        S LNO=I-1
...
%BSUB   S LCT=LCT-1 I LCT<1 U 0 W:'$D(%DX) !,"Specified partial global reference ",%NAM,"(",GLREF," not defined",! U %IOD G:'$D(%DX)
 %ST S POS=5 W:%CTC "*","*" W:'%CTC "*",!,"*",! G %ST
        S GLN="^"_%NAM_"("
        F I=1:1:LCT S Y=II(I) D:Y["""" %FIXQ S GLN=GLN_""""_Y_"""" I I<LCT S GLN=GLN_","
