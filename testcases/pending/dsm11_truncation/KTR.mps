...
BEGIN   S SDAT=%DAT,STIM=%TIM U %IOD S ERROR="^SYS(0,""ERROR"",-1)" F Z=0:0 S ERROR=$ZN(@ERROR) Q:$P(ERROR,",",2)'="""ERROR"""  D ER
R
        W # G SELECT
        ;;
...
LINE    S %DO=K-1*2+$P(ERR,";",2) D %DO,PAD W %DO,?15 S (RV,%DO)=$P(ERR,",",K) D %DO W $J(%DO,6),?28,ADR,?33 W:ADR'?." " "-"
        ...
        I TY="DL" S:ADR="RLCS" FN=RV\2#8 S:ADR="RLDA" ADR="RLDA-"_$S("5/1/6/4/7"[FN:"READ/WRITE",FN=2:"GET",FN=3:"SEEK",1:"") S:ADR=
"RLMP" ADR="RLMP-"_$S("5/1/6/7"[FN:"READ/WRITE",FN=2:"GET",FN=4:"READHDR",1:"")
BITS    S BT=-1
...
DR      ;;RMCS1;;RMWC;;RMBA;;RMDA;;RMCS2;;RMDS;;RMER1;;RMAS;;RMLA;;RMDB;;RMMR1;;RMDT;;RMSN;;RMOF;;RMDC;;RMHR;;RMMR2;;RMER2;;RMEC1;;R
MEC2
DB      ;;RPCS1;;RPWC;;RPBA;;RPDA;;RPCS2;;RPDS;;RPER1;;RPAS;;RPLA;;RPDB;;RPMR;;RPDT;;RPSN;;RPOF;;RPDC;;RPCC;;RPER2;;RPER3;;RPEC1;;RP
EC2
