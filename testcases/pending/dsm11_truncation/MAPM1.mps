...
VOLMOU  S VOL=$O(MPS(VOL)) I VOL'="" D  G:%A EXIT G VOLMOU
        ...
        .F U=0:1:7 I $V(U*4+D)#256=C,$V(U*4+D+1)<64 S DDU=TY_U D READ I %A=0,$C($V(LABEL+302,0)#256)="M"!$V(LABEL+303,0),S=(VOLNAM_V
OL),$V(LABEL+392,0)=CODE G GOTU
...
DONE    S %A=0
KILL    ;
EXIT    K TY,MPS,UNS,TYPES,LABEL,STRTAB,CODE,VOLS,VOL,PM,FREE,TOTFRE,DTBL,PTY,NTY,V22,SATOF,SATMM,MSAV,J0,J1,%JNAM,SP,INDEX,JJ,SCT,S
DP
