...
PROCON  I $V(DBPTR)=65535 S ERR=0 G EXIT
        ...
        S CONTYP="" F I=1:1:$P($T(CONTAB),";;",2) I $P($T(CONTAB+I),";;",2)=CON S CON=$P($T(CONTAB+I),";;",3),CONTYP=$P($T(CONTAB+I),";;",4+QB),REM=$P($T(CONTAB+I),";;",6) Q
        U 0 W !!,CON,CN
...
PTYP    :UNKNOWN:UNKNOWN:UNKNOWN:PDP-11/53:PDP-11/23:PDP-11/24:PDP-11/34:PDP-11/40:PDP-11/44:PDP-11/45:PDP-11/60:PDP-11/70:PDP-11/70:PDP-11/73:PDP-11/83:PDP-11/84
POPT    ;
...
EXIT    W !!
        K BOOTDK,BLK,ACF,CODE,MCOD,TTYPE,TUNIT,TREM,TVEC,TYPNM,UNITS,VEC,PTYP,OPT,REM,WRTIM,TCSR,O,M,J,CONTYP,CSR,DBPTR,%DO,%GARTRA,CN,CON,DEVAST,I,NO,QB,UNIT,UNTYP Q
        U 0:80 S DBPTR=ACF
