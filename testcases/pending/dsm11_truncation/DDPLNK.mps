DDPLNK  ;27-Feb-85 ;UTILITY ;DDP ;DDP LINK STATUS AND CONTROL UTILITY ;JHM
        D:$D(^UTILITY("MENU",$J,"MENU")) PUSH^%MENU S ^UTILITY("MENU",$J,"MENU")="^%MENU(""SYS"",""DDP"",""LINK MANAGEMENT"")" D %ST
T^%MENU
        S %NOPAUSE=1 Q
...
S3      D GETLNK W !?2,LNK,?6,TYP," (",DEV,")",?18,LNKSTA,?30,$J(ERR,6),?38,$J(DISC,6),?46,$J(XMTO,6),?54,$J(NRBUF,6),?63,ADDR,!?18,
LNKSRV Q
