...
HLP     W !,"If you have a group of terminals which you would like to declare as",!,"having identical characteristics, enter a range of device numbers.",!,"For example, enter ""64:79"" to select devices 64 through 79.",!
        W "If you want to establish characteristics on a device-by-device basis,",!,"then enter any terminal device number.",!
HDR     W !!,?4,"Parity",?11,"Auto",?23,"Modem",?30,"Output",?38,"Stall",?44,"Lower",!?7,"|",?11,"Baud",?23,"Cntrl",?31,"only",?38,"Count",?44,"Case",!,?7,"|",?13,"|",?25,"|",?32,"|",?40,"|",?46,"|"
        W !,"Device | CRT | Rcvr Xmit | ZUSE | Login | Tab | Output Rtn  Edit",!,"Number |  |  | Spd  Spd  |",?29,"|",?32,"|",?36,"|",?40,"|",?43,"|",?46,"|",?48,"Margin num Comment" Q
IV1     W !,"Enter ""Y"" or ""N"" or <CR>. <CR> gives the default.",! Q
IV2     W !,"Enter ""E"", ""O"" or ""N"". Enter <CR> to take the default.",! Q
IV3     W !,"Receive and transmit rates are as follows:",!?5,$P($T(@$S(CNT["DZ":"BAUD",CNT="DH11":"BAUD1",1:"BAUD2")),";;",2),!,"Enter one of the above, or <CR> to take the default.",! Q
IV4     W !,"Enter a number between 0 and 255, or <CR> to take the default.",!,"The value 0 causes there to be no margin.",! Q
IV5     W !,"Enter a number between 0 and 7 or <CR> to take the default.",!,"The number 0 causes there to be no routine tied to this terminal.",! Q
IV6     W !,"Enter the number (0-99) of pad characters required after control functions",!,"for this terminal. The number 0 causes no padding.",! Q
