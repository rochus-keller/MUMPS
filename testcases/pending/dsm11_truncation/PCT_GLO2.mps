...
SHOW    W !!!,"Global Characteristics for:  ^" W:$ZU(0)'=(%UCI_","_%SYS) "[",%UCI,",",%SYS,"]" W GLON,!!
        ...
        W ! S DIV=256 F %I=1:1:4 S DIV=DIV\4 W ?(%I-1*15+5),$P("System,World,Group,User",",",%I)," = ",$P("None,R,RW,RWD",",",DF("PR
O")\DIV#4+1)
        W ! Q
...
PB      .G PA:%IN=1 S %D=256 F %I=1:1:%IN-1 S %D=%D\4 W ?%I-1*18,$P("System,World,Group,User",",",%I)," <",$P("NONE,R,RW,RWD,",",",P
RO\%D#4+1),">"
        .G PA
