...
SHOW1   W "Space #",IX," on ",^SYS(0,"JOURNAL SPACE",IX,"DISK"),?17,"Name = ",^("NAME"),!
        ...
        W ?6,"Blocks Used     = ",$S(NEXTBLK?.N:NEXTBLK-^("START")-(NEXTBLK-^("START")\400),NEXTBLK="* EMPTY *":0,1:^("END")-^("STAR
T")+1\400*399),!
        W ?6,"Blks Remaining  = ",$S(NEXTBLK?.N:^("END")-NEXTBLK+1-(^("END")-NEXTBLK+400\400),NEXTBLK="* EMPTY *":^("END")-^("START"
)+1\400*399,1:0),!!
        K NEXTBLK
        Q
CUR     ;
