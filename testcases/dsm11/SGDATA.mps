...
START   W !,"PART 9:",?10,"SYSTEM DATA STRUCTURES",!,"-------",!
        ...
        I ^SYS(ID,"OPTIONS","DDP")="Y" S POOL=^SYS(ID,"MEM.ALLOC","DDP BUFFERS")\512+63\64*64+^("RV TABLE")+(64*128) D ROOM^SGBUFF G:%A RETURN W "Space allocated to DDP structures:",?50,$J(POOL,6)," Bytes",!
