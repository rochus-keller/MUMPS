...
%G2A    X "S $ZT=""%E3^%RS"" ZL @%NAM U %IOD W %NAM W:'((%DTY=""MT"")&(%MTM[""V"")) ! P  S %ZA=$ZA W:%DTY=""TRM""!(%DTY=""LP"")!(%DT
Y=""SC"") #,! U 0 I %IOD'=$I W:'(%CT#8) ! W ?(%CT#8*10),%NAM"
...
%DONE   U 0 K ^UTILITY($J) I $D(%IOD),%IOD'=$I U %IOD S ZA=$ZA,ZB=$ZB C %IOD U 0 I %DTY="SDP" W !,"Stopped at block #",ZA,",byte #",
ZB,!
        G %ST
