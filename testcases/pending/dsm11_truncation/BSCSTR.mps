...
Q5      S %QRY="Multipoint or Point-to-Point [M/P]",%DEF=^("NMOD"),%HLP="Q5H"
        ...
        S ^("NMOD")=%A G Q6:%A="P"
Q5A     S %QRY=$S(^("CSET")="A":"ASCII",1:"EBCDIC")_" decimal control Unit "_$S(^("NMOD")=2:"Poll ",1:"")_"Address",%DEF=^("CUPOL"),
%HLP="Q5AH"
        D QRY G Q5:%ANS="^" I %ANS'?1N.N!(%ANS>256)!(%ANS<0) D INVOPT G Q5A
        S ^("CUPOL")=%ANS I ^("EMUL")=1 S ^("CUPOL")=%ANS G Q6
Q5B     S %QRY=$S(^("CSET")="A":"ASCII",1:"EBCDIC")_" decimal control Unit "_$S(^("NMOD")=2:"Select ",1:"")_"Address",%DEF=^("CUSEL"
),%HLP="Q5BH"
