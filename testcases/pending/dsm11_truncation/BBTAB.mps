...
ASKM    S QUES="ADQ" D ASKYNB G ENTER:Y="^",DONE:'Y
        D BLKQ G ASKM:'BL
ASKM1   F I=1:1:%B I BL=%B(I) W "* Already in table *",! R !,"Do you want to put the spare block in the bad block table also? ",X G
ASKM:X'?1"Y".E S BL=400*%MP+I G ASKM1
        I '%UPG G ADBL
        U 63:(2:1:"CT")
...
RPT     F I=0:2:1022 V I:0:0
        ...
        U 0 W !,"Block is ",$S(BT!(BT'?.N):"",1:"not "),"in use" I BT!(BT'?.N) W " as a ",$S(BT="M":"Map",BT="R":"Spare Remapping",B
T=65535:"System",BT=65534:"V1.0 Bad",1:"Data or Routine")," block."
